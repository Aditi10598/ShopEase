...
const Cart = () => {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const response = await fetch("https://shopease-md4l.onrender.com/api/user/addresses", {
        headers: {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch("https://shopease-md4l.onrender.com/api/order/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
